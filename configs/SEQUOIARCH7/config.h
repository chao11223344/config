...
#define BOARD_NAME          SEQUOIARCH7
#define MANUFACTURER_ID     SERC
...
#define TIMER_PIN_MAPPING \
    ...
    TIMER_PIN_MAP( 4,  PE5 , 1,  5) \
    TIMER_PIN_MAP( 5,  PE6 , 1,  6) \
    TIMER_PIN_MAP( 6,  PB0 , 2,  7) \
